...
public class CalculatorTest extends FestSwingJUnitTestCase {
    ...
    public void sizeAndTitleCorrect() {
        ...
        Assert.assertEquals("Set correct title to JFrame", "logic.Calculator", frame.component().getTitle());
    }
    ...
    public void testComponentsAreFound() {
        ...
        assertEquals("logic.Calculator has wrong amount of JTextField-elements", 2, kentat.size());
        int e = 0;
        int d = 0;
        ...
        assertEquals("logic.Calculator has wrong amount of JTextField-elements which are set to enabled-state", 1, e);
        assertEquals("logic.Calculator has wrong amount of JTextField-elements which are not enabled", 1, d);
    }
