...
public class FileManagerTest {
    ...
    @Points("34.1")
    @Test
    public void readsLines1() throws Exception {
    ...
    @Points("34.1")
    @Test
    public void readsLines2() throws Exception {
        ArrayList<String> tekstit = new ArrayList<String>();
        tekstit.add("yy");
        tekstit.add("kaa");
    ...
    private void rivienLuku(ArrayList<String> tekstit, String tiedosto, String td) throws Exception {
        String sisalto = "";
        for (String teksti : tekstit) {
            sisalto += teksti + "\n";
        }
